...
static void preinitQt()
{
  ...
  QCoreApplication::setOrganizationDomain("abyssfin.app");
...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    parser.setApplicationDescription("Abyssfin");
    ...
    app.setWindowIcon(QIcon(":/images/icon.png"));
  	...
  	app.setWindowIcon(QIcon::fromTheme("org.abyssfin.Abyssfin", QIcon(":/images/icon.png")));
    // Set app id for Wayland compositor window icon
    app.setDesktopFileName("org.abyssfin.Abyssfin");
#endif
